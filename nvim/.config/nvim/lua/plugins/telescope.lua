return { -- Fuzzy Finder (files, lsp, etc)
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>sk", builtin.diagnostics, { desc = "[S]earch [D]iagnostics" })
		...
		vim.keymap.set("n", "<leader>sw", require("telescope").extensions.git_worktree.git_worktrees,
			{ desc = 'worktrees' })
	end,
}
